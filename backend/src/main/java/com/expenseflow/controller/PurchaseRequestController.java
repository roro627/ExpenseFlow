...
import com.expenseflow.service.PurchaseRequestService;
...
public class PurchaseRequestController {
    ...
    @GetMapping
    public PageResponse<PurchaseRequestResponse> list(@RequestParam(required = false) RequestStatus status,
    ...
    @GetMapping("/{id}")
    public PurchaseRequestResponse find(@PathVariable Long id) {
        return service.find(id);
    }

    @PostMapping
    public PurchaseRequestResponse create(@Valid @RequestBody PurchaseRequestRequest request) {
        return service.create(request);
    }

    @PutMapping("/{id}")
    public PurchaseRequestResponse update(@PathVariable Long id, @Valid @RequestBody PurchaseRequestRequest request) {
    ...
    public PurchaseRequestResponse managerDecision(@PathVariable Long id, @Valid @RequestBody ManagerDecisionRequest request) {
        return service.managerDecision(id, request);
    }

    @PostMapping("/{id}/finance/pay")
    public PurchaseRequestResponse pay(@PathVariable Long id, @Valid @RequestBody FinanceActionRequest request) {
